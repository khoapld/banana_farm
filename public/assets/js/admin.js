...
$(function () {
    ...
    // submit form
    var formName = [
        'create-user-form', 'update-user-form', 'update-profile-form',
        'create-group-form',
        'create-page-form'
    ];
...
function SubmitForm($form) {
    ...
    posting.done(function (data) {
        if (data.success) {
            if (fName === 'create-user-form' || fName === 'update-user-form') {
                location = '/admin/user';
                return false;
            }
...
//            show_alert_error(data.error);
            $form.find('.error.system').html(data.error);
        } else if (data.errors) {
//            var msg = '';
...
//            show_alert_error(msg);
            ...
            if (fName === 'create-group-form') {
                $('#group-list').html(data);
                resetForm($form);
            } else if (fName === 'create-page-form') {
                $('#page-list').html(data);
                resetForm($form);
            }
        }
